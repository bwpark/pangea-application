...
/**
 * REST controller for managing {@link com.nuri.pangea.domain.Emotion}.
 */
@RestController
@RequestMapping("/api")
public class EmotionResource {
    ...
    private static final String ENTITY_NAME = "emotion";
    ...
    public ResponseEntity<EmotionDTO> updateEmotion(@Valid @RequestBody EmotionDTO emotionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emotionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EmotionDTO> getEmotion(@PathVariable Long id) {
