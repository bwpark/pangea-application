...
public class Category2avatarResource {
    ...
    public ResponseEntity<Category2avatarLiteDTO> createCategory2avatar(@Valid @RequestBody Category2avatarLiteDTO category2avatarDTO)
        ...
        Category2avatarLiteDTO result = category2avatarService.save(category2avatarDTO);
        return ResponseEntity
            .created(new URI("/api/category-2-avatars/" + result.getId()))
    ...
    public ResponseEntity<Category2avatarLiteDTO> updateCategory2avatar(@Valid @RequestBody Category2avatarLiteDTO category2avatarDTO)
        throws URISyntaxException {
    ...
    public List<Category2avatarLiteDTO> getAllCategory2avatars() {
    ...
    public ResponseEntity<Category2avatarLiteDTO> getCategory2avatar(@PathVariable Long id) {
        log.debug("REST request to get Category2avatar : {}", id);
        Optional<Category2avatarLiteDTO> category2avatarDTO = category2avatarService.findOne(id);
