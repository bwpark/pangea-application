...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pangeaApplicationApp.category.delete.question">
        <Translate contentKey="pangeaApplicationApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-category" color="danger" onClick={confirmDelete}>
