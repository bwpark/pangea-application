...
export const ReportDeleteDialog = (props: IReportDeleteDialogProps) => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.reportEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pangeaApplicationApp.report.delete.question">
        <Translate contentKey="pangeaApplicationApp.report.delete.question" interpolate={{ id: reportEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-report" color="danger" onClick={confirmDelete}>
