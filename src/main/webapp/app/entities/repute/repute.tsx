  ...
  return (
    <div>
      <h2 id="repute-heading">
        <Translate contentKey="pangeaApplicationApp.repute.home.title">Reputes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="pangeaApplicationApp.repute.home.createLabel">Create new Repute</Translate>
        </Link>
      </h2>
        ...
        {reputeList && reputeList.length > 0 ? (
            ...
            <tbody>
              {reputeList.map((repute, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{repute.credit}</td>
                  <td>
                    <Translate contentKey={`pangeaApplicationApp.ReputeStatus.${repute.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="pangeaApplicationApp.repute.home.notFound">No Reputes found</Translate>
            </div>
          )
        )}
      </div>
